...
function TestimonialCard() {
  return (
    <div className="p-4 lg:p-10 flex flex-col gap-3 lg:gap-7">
      <div className="icon">
        <svg  className="w-10 fill-orange lg:fill-indigo" viewBox="0 0 20 14" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            id="&#226;&#128;&#156;"
      ...
      <p className="text-sm text-gray leading-7">
        I recently purchased furniture from this website, and I couldn't be happier with my experience. The quality of the furniture is outstanding, and it arrived exactly as described. The customer service was
        top-notch, with prompt and helpful responses to all my inquiries. I highly recommend this website for anyone looking to buy furniture for their home.
      </p>
      <div className="user flex justify-between">
        <div className="user-info flex items-center gap-2">
          <img className="rounded-full w-6 h-6" src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt="" />
